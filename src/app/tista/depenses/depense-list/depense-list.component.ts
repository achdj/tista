...
import { DepenseService } from 'src/app/general/services/depense.service';
...
export class DepenseListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['description', 'AmountExp', 'doAt','actions'];
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatPaginator) paginator: MatPaginator;
  searchKey: string;

  ngOnInit(): void {
    this.service.getDepenses().subscribe(
      list => {
  ...
  onCreate(){
    ...
    this.dialog.open(DepenseComponent, dialogConfig);
  }
  ...
  onDelete($key){
    ...
    .afterClosed().subscribe(res =>{
      if(res){
        this.service.deleteDepense($key);
        this.notificationService.warn('! Supprimer avec succes');
      }
    });
