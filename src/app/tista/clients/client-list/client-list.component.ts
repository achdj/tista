...
import { ClientService } from 'src/app/general/services/client.service';
...
export class ClientListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['email', 'nom', 'prenom', 'menberSince', 'adresse', 'sex', 'dob', 'phoneNumber', 'isActivate','actions'];
